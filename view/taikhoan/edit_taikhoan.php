                            ...
                            <div class="your-details">
                              ...
                              <div class="pass-wrap">
                                <div class="form-row">
                                  ...
                                  <input type="password" class="input namefild" name="pass" value="<?=$pass?>">
                                </div>
                                <!-- <div class="form-row">
                                  <label class="lebel-abs"> 
                                    Nhập lại mật khẩu
                              ...
                              <div class="form-row">
                                ...
                                <input type="text" class="input namefild" name="tel" value="<?=$tel?>">
                              </div>
                              ...
                              <!-- <p>
                                ...
                                <span class="text">
                                Tôi muốn đăng ký nhận bản tin của ShopGiaThang </span>
                              </p> -->
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="your-details">
                              <h5>
                               ...
                               <div class="form-row">
                                ...
                                <input type="text" class="input namefild" name="address" value="<?=$address?>">
                              </div>
                               <div class="form-row">
                                <label class="lebel-abs">
                                  Quê quán :
                                ...
                                <input type="text" class="input namefild">
                              </div>
                              <!-- <div class="form-row">
                                <label class="lebel-abs">
                                  City 
